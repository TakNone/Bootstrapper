...
$invoice = $client->invoice(
	...
	recurring : true,
	currency : 'RkWea4n3fbLg2B0r',
	prices : array(
		$client->labeledPrice(
			label : 'zmZwaTRqdvfWIKDb',
			amount : 1674287661247540478,
		),
	),
	max_tip_amount : -5003481980554638141,
	suggested_tip_amounts : array(1363710542319135940),
