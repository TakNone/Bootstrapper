...
$invoice = $client->invoice(
	...
	recurring : true,
	currency : 'epJlaOS4FMs1wgbc',
	prices : array(
		$client->labeledPrice(
			label : 'hQ7fs5TLCo1BItzG',
			amount : 6533614119134924566,
		),
	),
	max_tip_amount : -89531979662089900,
	suggested_tip_amounts : array(6986340520999200902),
