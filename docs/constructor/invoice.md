...
$invoice = $client->invoice(
	...
	recurring : true,
	currency : 'bJpVojsMKrGlqCed',
	prices : array(
		$client->labeledPrice(
			label : '0jNcTpVSwFrzLY9Q',
			amount : -4728057931396438682,
		),
	),
	max_tip_amount : 2499768277166390888,
	suggested_tip_amounts : array(-6788214736726284648),
