...
$availableEffect = $client->availableEffect(
	...
	id : 1711144218067790554,
	emoticon : 'ET12wpYtoXqeUmDN',
	static_icon_id : -8811026680720685569,
	effect_sticker_id : 1904843665499013926,
	effect_animation_id : 3310133429938534269,
);
```