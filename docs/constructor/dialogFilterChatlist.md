	...
	title : $client->textWithEntities(
		...
		entities : array(
			...
			$client->messageEntityCustomEmoji(
				offset : 0,
				length : 82,
				document_id : 5690651139556972518,
			),
