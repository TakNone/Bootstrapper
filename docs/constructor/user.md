...
$user = $client->user(
	...
	bot_guestchat : true,
	bot_guard : true,
	id : -2482473050547715016,
	access_hash : -6619522194714311107,
	first_name : 'Tak',
	last_name : 'None',
	username : 'TakNone',
	phone : '+1234567890',
	...
	restriction_reason : array(
		$client->restrictionReason(
			platform : 'Wov0PdJh1KtgO2NI',
			reason : 'vj4pkZ1WtEcuQKwD',
			text : 'nGDBXu7qf80WIzVO',
		),
	),
	bot_inline_placeholder : '2jtzeqOTriAnZVDQ',
	lang_code : 'M2vyZeRwxAp7J3a1',
	...
	color : $client->peerColor(
		color : 22,
		background_emoji_id : -5291606382238955213,
	),
	profile_color : $client->peerColor(
		color : 61,
		background_emoji_id : -2600446646948352716,
	),
	bot_active_users : 39,
	bot_verification_icon : -9023575864550754123,
	send_paid_messages_stars : -8868916516572176154,
);
```