...
$user = $client->user(
	...
	id : 2464065433027597811,
	access_hash : -977181285121196784,
	first_name : 'Tak',
	last_name : 'None',
	username : 'TakNone',
	phone : '+1234567890',
	...
	restriction_reason : array(
		$client->restrictionReason(
			platform : 'S94JXW6elyBoIHsn',
			reason : 'DbAEOr1hnFGmKBkp',
			text : 'ghaP3kDeBuoHYtcU',
		),
	),
	bot_inline_placeholder : 'MCasiSJEI7dZVvB3',
	lang_code : 'UMIrzRsZnlujJEdP',
	...
	color : $client->peerColor(
		color : 14,
		background_emoji_id : 6920568379246328516,
	),
	profile_color : $client->peerColor(
		color : 98,
		background_emoji_id : 3611601201581992415,
	),
	bot_active_users : 25,
	bot_verification_icon : -180584688486232233,
	send_paid_messages_stars : -3825921526602082152,
);
```