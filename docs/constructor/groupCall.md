...
$groupCall = $client->groupCall(
	...
	min : true,
	id : 5218380225706936497,
	access_hash : -8257135148343050202,
	participants_count : 87,
	title : 'S28F7WTapke5ZPdC',
	stream_dc_id : 52,
	record_start_date : 85,
	schedule_date : 87,
	unmuted_video_count : 53,
	unmuted_video_limit : 19,
	version : 14,
	invite_link : 'ptujXkyLn37FUZcg',
	send_paid_messages_stars : 481525110987858696,
	default_send_as : $client->peerUser(
		user_id : -777526732913486079,
	),
);
```