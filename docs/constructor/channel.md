...
$chat = $client->channel(
	...
	monoforum : true,
	forum_tabs : true,
	id : -8230816581815046632,
	access_hash : 1677034463126924860,
	title : 'XtJ8OhVNKobusGLk',
	username : 'TakNone',
	photo : $client->chatPhotoEmpty(),
	date : 46,
	restriction_reason : array(
		$client->restrictionReason(
			platform : '6E7FQCGeiqL4Rnu2',
			reason : 'JkuQCiEmTZRv9MVg',
			text : 'mZvNwpT2V0gysCcj',
		),
	),
	...
	color : $client->peerColor(
		color : 93,
		background_emoji_id : 4889217552804694953,
	),
	profile_color : $client->peerColor(
		color : 15,
		background_emoji_id : 3366849752530071231,
	),
	emoji_status : $client->emojiStatusEmpty(),
	level : 91,
	subscription_until_date : 63,
	bot_verification_icon : 2310507269178264215,
	send_paid_messages_stars : -5940747781425207753,
	linked_monoforum_id : -6214319992988933795,
);
```