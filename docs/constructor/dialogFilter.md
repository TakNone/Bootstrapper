	...
	title : $client->textWithEntities(
		...
		entities : array(
			...
			$client->messageEntityCustomEmoji(
				offset : 0,
				length : 0,
				document_id : -8871799029325195491,
			),
