...
$config = $client->config(
	...
	dc_txt_domain_name : 'LbsnuE03KidZwoBl',
	chat_size_max : 88,
	megagroup_size_max : 86,
	forwarded_count_max : 82,
	online_update_period_ms : 26,
	offline_blur_timeout_ms : 38,
	offline_idle_timeout_ms : 98,
	online_cloud_timeout_ms : 6,
	notify_cloud_delay_ms : 98,
	notify_default_delay_ms : 18,
	push_chat_period_ms : 11,
	push_chat_limit : 54,
	edit_time_limit : 54,
	revoke_time_limit : 34,
	revoke_pm_time_limit : 39,
	rating_e_decay : 13,
	stickers_recent_limit : 18,
	channels_read_media_period : 61,
	tmp_sessions : 56,
	call_receive_timeout_ms : 86,
	call_ring_timeout_ms : 15,
	call_connect_timeout_ms : 19,
	call_packet_timeout_ms : 94,
	...
	static_maps_provider : 'vUR86y5WTrwLetO7',
	caption_length_max : 11,
	message_length_max : 22,
	webfile_dc_id : 8,
	suggested_lang_code : 'iPTn8N2OfDYsGgcW',
	lang_pack_version : 91,
	base_lang_pack_version : 95,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'TSsF97Yu1VxN8fnh',
);
```