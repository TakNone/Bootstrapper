...
$config = $client->config(
	...
	dc_txt_domain_name : '29ysX8jhgPSGVxeu',
	chat_size_max : 33,
	megagroup_size_max : 54,
	forwarded_count_max : 62,
	online_update_period_ms : 49,
	offline_blur_timeout_ms : 65,
	offline_idle_timeout_ms : 2,
	online_cloud_timeout_ms : 32,
	notify_cloud_delay_ms : 17,
	notify_default_delay_ms : 48,
	push_chat_period_ms : 64,
	push_chat_limit : 0,
	edit_time_limit : 37,
	revoke_time_limit : 15,
	revoke_pm_time_limit : 72,
	rating_e_decay : 86,
	stickers_recent_limit : 90,
	channels_read_media_period : 50,
	tmp_sessions : 78,
	call_receive_timeout_ms : 79,
	call_ring_timeout_ms : 3,
	call_connect_timeout_ms : 46,
	call_packet_timeout_ms : 66,
	...
	static_maps_provider : 'hf0VNoJdTrc5s3aA',
	caption_length_max : 31,
	message_length_max : 66,
	webfile_dc_id : 8,
	suggested_lang_code : 'PsueyYC8tpma09jU',
	lang_pack_version : 21,
	base_lang_pack_version : 85,
	reactions_default : $client->reactionEmpty(),
	autologin_token : '5u4AlVEsIbitvFJp',
);
```