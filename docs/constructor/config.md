...
$config = $client->config(
	...
	dc_txt_domain_name : 'pZLvk2nhWHPgB7dF',
	chat_size_max : 32,
	megagroup_size_max : 31,
	forwarded_count_max : 86,
	online_update_period_ms : 13,
	offline_blur_timeout_ms : 7,
	offline_idle_timeout_ms : 2,
	online_cloud_timeout_ms : 20,
	notify_cloud_delay_ms : 34,
	notify_default_delay_ms : 34,
	push_chat_period_ms : 96,
	push_chat_limit : 78,
	edit_time_limit : 79,
	revoke_time_limit : 29,
	revoke_pm_time_limit : 58,
	rating_e_decay : 95,
	stickers_recent_limit : 76,
	channels_read_media_period : 12,
	tmp_sessions : 69,
	call_receive_timeout_ms : 9,
	call_ring_timeout_ms : 28,
	...
	static_maps_provider : 'vPlEqt7sWUQJryBc',
	caption_length_max : 47,
	message_length_max : 88,
	webfile_dc_id : 37,
	suggested_lang_code : 'BdvTnEgSqo3XRIMW',
	lang_pack_version : 77,
	base_lang_pack_version : 70,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'P8NjEk5ZCYQ2D0RS',
);
```