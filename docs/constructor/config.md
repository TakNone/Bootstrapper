...
$config = $client->config(
	...
	dc_txt_domain_name : '4k7FfI2RSMHrsGBD',
	chat_size_max : 16,
	megagroup_size_max : 53,
	forwarded_count_max : 48,
	online_update_period_ms : 87,
	offline_blur_timeout_ms : 90,
	offline_idle_timeout_ms : 77,
	online_cloud_timeout_ms : 78,
	notify_cloud_delay_ms : 40,
	notify_default_delay_ms : 78,
	push_chat_period_ms : 18,
	push_chat_limit : 32,
	edit_time_limit : 37,
	revoke_time_limit : 40,
	revoke_pm_time_limit : 60,
	rating_e_decay : 4,
	stickers_recent_limit : 23,
	channels_read_media_period : 57,
	tmp_sessions : 86,
	call_receive_timeout_ms : 36,
	call_ring_timeout_ms : 43,
	call_connect_timeout_ms : 79,
	...
	static_maps_provider : 'jDGcbBiFCmw2a6kd',
	caption_length_max : 4,
	message_length_max : 4,
	webfile_dc_id : 34,
	suggested_lang_code : 'RlHKftcZ3qQ6XCIM',
	lang_pack_version : 95,
	base_lang_pack_version : 28,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'xY43ILmrNchAaXDH',
);
```