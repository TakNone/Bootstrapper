...
$config = $client->config(
	...
	dc_txt_domain_name : 'KJEDlYkhW6X8iRyO',
	chat_size_max : 73,
	megagroup_size_max : 57,
	forwarded_count_max : 95,
	online_update_period_ms : 95,
	offline_blur_timeout_ms : 97,
	offline_idle_timeout_ms : 17,
	online_cloud_timeout_ms : 86,
	notify_cloud_delay_ms : 95,
	notify_default_delay_ms : 19,
	push_chat_period_ms : 59,
	push_chat_limit : 27,
	edit_time_limit : 88,
	revoke_time_limit : 27,
	revoke_pm_time_limit : 29,
	rating_e_decay : 68,
	stickers_recent_limit : 55,
	channels_read_media_period : 74,
	tmp_sessions : 44,
	call_receive_timeout_ms : 45,
	call_ring_timeout_ms : 36,
	call_connect_timeout_ms : 10,
	call_packet_timeout_ms : 53,
	...
	static_maps_provider : 'sHvBGNctbTYFkV93',
	caption_length_max : 33,
	message_length_max : 76,
	webfile_dc_id : 20,
	suggested_lang_code : 'YzncryBNaOH2Q1h6',
	lang_pack_version : 53,
	base_lang_pack_version : 97,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'xqMRfp6zkWlgEeU1',
);
```