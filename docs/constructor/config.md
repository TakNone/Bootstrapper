...
$config = $client->config(
	...
	dc_txt_domain_name : 'M5ctwgqs2XjYNEB6',
	chat_size_max : 69,
	megagroup_size_max : 73,
	forwarded_count_max : 20,
	online_update_period_ms : 3,
	offline_blur_timeout_ms : 86,
	offline_idle_timeout_ms : 93,
	online_cloud_timeout_ms : 17,
	notify_cloud_delay_ms : 99,
	notify_default_delay_ms : 69,
	push_chat_period_ms : 21,
	push_chat_limit : 40,
	edit_time_limit : 93,
	revoke_time_limit : 90,
	revoke_pm_time_limit : 100,
	rating_e_decay : 0,
	stickers_recent_limit : 56,
	channels_read_media_period : 34,
	tmp_sessions : 83,
	call_receive_timeout_ms : 69,
	call_ring_timeout_ms : 34,
	call_connect_timeout_ms : 7,
	call_packet_timeout_ms : 59,
	...
	static_maps_provider : '41GpsteMglor7C6c',
	caption_length_max : 54,
	message_length_max : 20,
	webfile_dc_id : 12,
	suggested_lang_code : 'PNDWqIgbZreVj19C',
	lang_pack_version : 75,
	base_lang_pack_version : 16,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'qNdD8raWnk6efMQP',
);
```