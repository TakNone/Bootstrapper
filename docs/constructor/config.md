...
$config = $client->config(
	...
	dc_txt_domain_name : 'xqIVo18wsLODXkGK',
	chat_size_max : 75,
	megagroup_size_max : 27,
	forwarded_count_max : 22,
	online_update_period_ms : 83,
	offline_blur_timeout_ms : 58,
	offline_idle_timeout_ms : 2,
	online_cloud_timeout_ms : 70,
	notify_cloud_delay_ms : 97,
	notify_default_delay_ms : 49,
	push_chat_period_ms : 31,
	push_chat_limit : 49,
	edit_time_limit : 86,
	revoke_time_limit : 73,
	revoke_pm_time_limit : 4,
	rating_e_decay : 8,
	stickers_recent_limit : 49,
	channels_read_media_period : 86,
	tmp_sessions : 22,
	call_receive_timeout_ms : 13,
	call_ring_timeout_ms : 5,
	call_connect_timeout_ms : 61,
	call_packet_timeout_ms : 71,
	...
	static_maps_provider : 'cZ14C6bUoEXkSpGY',
	caption_length_max : 63,
	message_length_max : 92,
	webfile_dc_id : 99,
	suggested_lang_code : 'DJBW8k305sgndmyp',
	lang_pack_version : 79,
	base_lang_pack_version : 26,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'dRCP7GhtvBF4rfIn',
);
```