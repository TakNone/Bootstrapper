...
$config = $client->config(
	...
	dc_txt_domain_name : 'rMohuzmGwePZ4UKa',
	chat_size_max : 6,
	megagroup_size_max : 81,
	forwarded_count_max : 36,
	online_update_period_ms : 10,
	offline_blur_timeout_ms : 100,
	offline_idle_timeout_ms : 82,
	online_cloud_timeout_ms : 83,
	notify_cloud_delay_ms : 45,
	notify_default_delay_ms : 97,
	push_chat_period_ms : 70,
	push_chat_limit : 49,
	edit_time_limit : 7,
	revoke_time_limit : 3,
	...
	channels_read_media_period : 79,
	tmp_sessions : 49,
	call_receive_timeout_ms : 98,
	call_ring_timeout_ms : 8,
	call_connect_timeout_ms : 33,
	call_packet_timeout_ms : 49,
	...
	static_maps_provider : 'zfjJEnqRbI4vX570',
	caption_length_max : 53,
	message_length_max : 60,
	webfile_dc_id : 39,
	suggested_lang_code : 'QzwWEZi8tq9pmIec',
	lang_pack_version : 19,
	base_lang_pack_version : 73,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'ofkwlbUZQntW3q6x',
);
```