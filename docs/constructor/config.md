...
$config = $client->config(
	...
	dc_txt_domain_name : 'GIeMTjlZS6OECrap',
	chat_size_max : 86,
	megagroup_size_max : 86,
	forwarded_count_max : 95,
	online_update_period_ms : 93,
	offline_blur_timeout_ms : 90,
	offline_idle_timeout_ms : 7,
	online_cloud_timeout_ms : 67,
	notify_cloud_delay_ms : 67,
	notify_default_delay_ms : 90,
	...
	rating_e_decay : 75,
	stickers_recent_limit : 81,
	channels_read_media_period : 8,
	tmp_sessions : 57,
	call_receive_timeout_ms : 69,
	call_ring_timeout_ms : 52,
	call_connect_timeout_ms : 24,
	call_packet_timeout_ms : 78,
	...
	static_maps_provider : 'RvOaCMrA0otQ8Iun',
	caption_length_max : 23,
	message_length_max : 26,
	webfile_dc_id : 19,
	suggested_lang_code : 'TjR2v8QbP3SiwZMV',
	lang_pack_version : 26,
	base_lang_pack_version : 2,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'FXf2viK964OjtdMI',
);
```