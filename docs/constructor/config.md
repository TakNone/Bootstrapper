...
$config = $client->config(
	...
	dc_txt_domain_name : 'Y5yVIEfZXe8k1To6',
	chat_size_max : 44,
	megagroup_size_max : 45,
	forwarded_count_max : 67,
	online_update_period_ms : 12,
	offline_blur_timeout_ms : 82,
	offline_idle_timeout_ms : 98,
	online_cloud_timeout_ms : 42,
	notify_cloud_delay_ms : 26,
	notify_default_delay_ms : 77,
	push_chat_period_ms : 75,
	push_chat_limit : 10,
	edit_time_limit : 27,
	revoke_time_limit : 85,
	revoke_pm_time_limit : 93,
	rating_e_decay : 54,
	stickers_recent_limit : 43,
	channels_read_media_period : 42,
	tmp_sessions : 79,
	call_receive_timeout_ms : 65,
	call_ring_timeout_ms : 73,
	call_connect_timeout_ms : 63,
	call_packet_timeout_ms : 73,
	...
	static_maps_provider : '3pK7BOSexHytl1qW',
	caption_length_max : 70,
	message_length_max : 43,
	webfile_dc_id : 51,
	suggested_lang_code : 'wQDP2d3vJLVnOWq0',
	lang_pack_version : 69,
	base_lang_pack_version : 38,
	reactions_default : $client->reactionEmpty(),
	autologin_token : 'lSqE9YcNOA7mzTrH',
);
```