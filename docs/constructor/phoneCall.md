...
$phoneCall = $client->phoneCall(
	...
	id : -6594599566401071266,
	access_hash : 2286583766857959487,
	date : 37,
	admin_id : 4574825308064396789,
	participant_id : 5703037724635709540,
	g_a_or_b : "\x4c\x69\x76\x65\x50\x72\x6f\x74\x6f",
	key_fingerprint : -1967936708585250795,
	protocol : $client->phoneCallProtocol(
		udp_p2p : true,
		udp_reflector : true,
		min_layer : 41,
		max_layer : 2,
		library_versions : array('ICxhZejamVlAgkn7'),
	),
	connections : array(
		$client->phoneConnection(
			tcp : true,
			id : -4544083057908864668,
			ip : '127.0.0.1',
			ipv6 : '127.0.0.1',
			port : 98,
		...
		$client->phoneConnectionWebrtc(
			turn : true,
			stun : true,
			id : -6351099613615311228,
			ip : '127.0.0.1',
			ipv6 : '127.0.0.1',
			port : 69,
			username : 'TakNone',
			password : 'nfLJDmEOVNZjIWw2',
		),
	),
	start_date : 46,
	custom_parameters : $client->dataJSON(
		data : 'FM7Nx2iWRheAodYs',
	),
);
```