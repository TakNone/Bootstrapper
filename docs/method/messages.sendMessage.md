...
$updates = $client->messages->sendMessage(
	...
	reply_to : $client->inputReplyToMessage(
		...
		quote_entities : array(
			...
			$client->messageEntityCustomEmoji(
				offset : 13,
				length : 11,
				document_id : 8996292568080084456,
			),
	...
	message : 'fruJkwP9y6KUGlFp',
	random_id : -7372239095169149346,
	...
	entities : array(
		...
		$client->messageEntityCustomEmoji(
			offset : 19,
			length : 18,
			document_id : 925214164791776994,
		),
		$client->messageEntityBlockquote(
			collapsed : true,
			offset : 15,
	...
	quick_reply_shortcut : $client->inputQuickReplyShortcut(
		shortcut : 'oEsA9BNHMPaJzxYW',
	),
	effect : -6289848965202548722,
	allow_paid_stars : 913449946376660496,
	suggested_post : $client->suggestedPost(
		accepted : true,
		rejected : true,
		price : $client->starsAmount(
			amount : 7910855392135773623,
			nanos : 57,
		),
		schedule_date : 19,
	),
