...
$updates = $client->messages->forwardMessages(
	...
	id : array(83),
	random_id : array(-6551506261276267289),
	...
	reply_to : $client->inputReplyToMessage(
		...
		quote_entities : array(
			...
			$client->messageEntityCustomEmoji(
				offset : 4,
				length : 1,
				document_id : 1515090657141363662,
			),
	...
	quick_reply_shortcut : $client->inputQuickReplyShortcut(
		shortcut : '2LVIebkQBXTjKJAP',
	),
	video_timestamp : 86,
	allow_paid_stars : -3704310503536136743,
	suggested_post : $client->suggestedPost(
		accepted : true,
		rejected : true,
		price : $client->starsAmount(
			amount : 3976490945445607450,
			nanos : 33,
		),
		schedule_date : 95,
	),
