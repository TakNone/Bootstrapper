...
$updates = $client->messages->sendMedia(
	...
	reply_to : $client->inputReplyToMessage(
		...
		quote_entities : array(
			...
			$client->messageEntityCustomEmoji(
				offset : 4,
				length : 75,
				document_id : 6006128888952350198,
			),
	...
	message : 'Xa30Hmy5Id62Pezv',
	random_id : -3386626494268547972,
	...
	entities : array(
		...
		$client->messageEntityCustomEmoji(
			offset : 65,
			length : 40,
			document_id : -7788043006506472957,
		),
		$client->messageEntityBlockquote(
			collapsed : true,
			offset : 48,
	...
	quick_reply_shortcut : $client->inputQuickReplyShortcut(
		shortcut : 'J6AdspvB5meRgCEw',
	),
	effect : -5046651920860494742,
	allow_paid_stars : 1189867801916743705,
	suggested_post : $client->suggestedPost(
		accepted : true,
		rejected : true,
		price : $client->starsAmount(
			amount : 2525964932598511738,
			nanos : 16,
		),
		schedule_date : 80,
	),
