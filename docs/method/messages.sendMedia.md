...
$updates = $client->messages->sendMedia(
	...
	reply_to : $client->inputReplyToMessage(
		...
		quote_entities : array(
			...
			$client->messageEntityCustomEmoji(
				offset : 98,
				length : 4,
				document_id : -7415369585627824658,
			),
	...
	message : 'LQ73zMb5Pn9wJOjS',
	random_id : -7219121757674971719,
	...
	entities : array(
		...
		$client->messageEntityCustomEmoji(
			offset : 77,
			length : 86,
			document_id : 8312525771261702306,
		),
		$client->messageEntityBlockquote(
			collapsed : true,
			offset : 85,
	...
	quick_reply_shortcut : $client->inputQuickReplyShortcut(
		shortcut : 'jHPAX2viyrS8f7n6',
	),
	effect : -634616905306195117,
	allow_paid_stars : -4434535220480928644,
	suggested_post : $client->suggestedPost(
		accepted : true,
		rejected : true,
		price : $client->starsAmount(
			amount : 2674430370754419578,
			nanos : 91,
		),
		schedule_date : 1,
	),
