...
function setup(string $path) : void {
	...
	$errorscontent = json_decode(file_get_contents('http://core.telegram.org/file/400780400470/3/OY6JMkb69K4.143326.json/3c10f72ff9ce45e8a9'),flags : JSON_THROW_ON_ERROR);
